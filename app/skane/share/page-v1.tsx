...
import SkaneShareCardV1 from "@/components/skane/SkaneShareCardV1";
...
export default function SharePageV1() {
    ...
    <main className="fixed inset-0 bg-black">
      ...
      <AnimatePresence mode="wait">
        {step === "selfie" ? (
          ...
          >
            <div className="absolute top-0 left-0 right-0 z-20 p-5 flex items-center justify-between">
              ...
              <span className="text-white/60 text-sm">
                {t("share.selfieTitle", "Selfie victoire")}
              </span>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 flex flex-col items-center">
              <p className="text-white/80 text-center mb-6 text-sm">
                {t("share.selfieInstructions", "Montre ton visage après l'exercice !")}
                <br />
                <span className="text-white/50">
                  {t("share.selfieSubtext", "Souris, tu l'as mérité")}
                </span>
              </p>
              ...
              <motion.button
                ...
                style={{
                  boxShadow:
                    "0 0 0 4px rgba(255,255,255,0.3), 0 8px 32px rgba(0,0,0,0.5)",
                }}
              >
          ...
          >
            <SkaneShareCardV1
              capturedImage={selfieUrl || ""}
              skaneIndexBefore={result.skaneIndex}
              skaneIndexAfter={skaneIndexAfter}
              microActionName={
                getMicroActionDetails(result.microAction)?.name || result.microAction
              }
              onShare={handleShare}
            />

/**
 * Selector V1 - Précision Maximale
 *
 * 4 règles : exclure feedback négatif < 24h, forcer 70% actions cœur,
 * éviter même action > 3x consécutives, fallback airbag.
 */
...
export async function selectMicroActionV1(
  state: InternalState,
  userId: string | null,
  isGuestMode: boolean
): Promise<SelectionResultV1> {

...
export default function LegalNoticePage() {
  ...
  const sectionsValue = tRaw("legalNoticePage.sections", { returnObjects: true }) as Record<
    string,
          ...
          >
            ...
            >
              <p className="text-sm text-gray-300 m-0">
                <strong>{t("legalNoticePage.updatedLabel")}:</strong> {t("legalNoticePage.updatedValue")}
              </p>
            </div>

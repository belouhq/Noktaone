...
export default function TermsOfServicePage() {
  ...
  const sectionsValue = tRaw("termsPage.sections", { returnObjects: true }) as Record<
    string,
          ...
          >
            ...
            >
              <p className="text-sm text-gray-300 m-0">
                <strong>{t("termsPage.versionLabel")}:</strong> {t("termsPage.versionValue")}
                <br />
                <strong>{t("termsPage.updatedLabel")}:</strong> {t("termsPage.updatedValue")}
              </p>
            </div>
